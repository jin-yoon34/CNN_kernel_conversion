...
train_image_db = lmdb.open("/mnt/DATA/jhy2118/"+"train_image_"+KERNEL_from+"to"+KERNEL_to, map_async=True, max_dbs=0)
train_label_db = lmdb.open("/mnt/DATA/jhy2118/"+"train_label_"+KERNEL_from+"to"+KERNEL_to, map_async=True, max_dbs=0)
...
_save_mean(mean_image, "/mnt/DATA/jhy2118/"+"train_image_mean_"+KERNEL_from+"to"+KERNEL_to+".png")
_save_mean(mean_image, "/mnt/DATA/jhy2118/"+"train_image_mean_"+KERNEL_from+"to"+KERNEL_to+".binaryproto")
